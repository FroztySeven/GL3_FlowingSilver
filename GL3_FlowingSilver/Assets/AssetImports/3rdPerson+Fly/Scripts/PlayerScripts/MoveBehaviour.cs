...
public class MoveBehaviour : GenericBehaviour
{
	...
	public override void LocalFixedUpdate()
	{
        ...
        // Our movement animation
        if(behaviourManager.GetH != 0 || behaviourManager.GetV != 0) {
            GameObject.FindWithTag("Child").GetComponent<Animator>().SetBool("isWalking", true);
            iswalking = true;
        }
        else
        {
	...
	void MovementManagement(float horizontal, float vertical)
	{
		...
		if (behaviourManager.IsSprinting())
		{
			speed = sprintSpeed;
            GameObject.FindWithTag("Child").GetComponent<Animator>().SetBool("isWalking", false);
            GameObject.FindWithTag("Child").GetComponent<Animator>().SetBool("isSprinting", true);
        }
        else
        {
            GameObject.FindWithTag("Child").GetComponent<Animator>().SetBool("isWalking", false);
            GameObject.FindWithTag("Child").GetComponent<Animator>().SetBool("isSprinting", false);
        }
